...
function ChatData() {
  ...
  this.data = {
    ...
    help8: {
      bubbles: ['Oł jee. <span class="emojione emojione-1f46f"></span><span class="emojione emojione-1f46f"></span>', '<img src="https://media.giphy.com/media/NGSbD5vI6lUvC/giphy.gif" />', "Gotowy na kolejne przykłady?"],
    ...
    troll3: {
      bubbles: ["Tak jest!", '<img src="/c/i/gif/ec102c9aae2cd90bc964393567b947f4.gif" />', 'Jak powiesz <q>te trolle</q>?'],
    ...
    end3: {
      bubbles: ['Dzięki. <span class="emojione emojione-2764"></span> Tu jest link:', '<a href="http://nocnasowa.pl/norweski-rzeczownik-aplikacja/" title="">Norweski rzeczownik – aplikacja Nocnej Sowy</a>'],
      autoNext: "endEnd"
    },
    end4: {
