...
<div class="section-content section-6-2">
  <div id="audio-test" class="col-10 center">
    ...
    <div id="audio-test-answers" class="audio-test-answers section-blue rounded space-x2" style="overflow:hidden;">
      <p id="audio-msg" class="centered space-0 pad-2 size-2"></p>

      <button id="answer-one" class="btn btn-blue btn-audio-test-answer" role="button" style="width:100%;display:none;padding:2rem;margin:0;opacity:0;border-radius:0;border-top:1px solid #fff;">&nbsp;</button>

      <button id="answer-two" class="btn btn-blue btn-audio-test-answer" role="button" style="width:100%;display:none;padding:2rem;margin:0;opacity:0;border-radius:0;border-top:1px solid #fff;">&nbsp;</button>

      <button id="answer-three" class="btn btn-blue btn-audio-test-answer" role="button" style="width:100%;display:none;padding:2rem;margin:0;opacity:0;border-radius:0;border-top:1px solid #fff;">&nbsp;</button>

      <button id="answer-four" class="btn btn-blue btn-audio-test-answer" role="button" style="width:100%;display:none;padding:2rem;margin:0;opacity:0;border-radius:0;border-top:1px solid #fff;">&nbsp;</button>
    </div>
